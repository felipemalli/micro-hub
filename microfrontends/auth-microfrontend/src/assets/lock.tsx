...
export const Icon = (props: SVGProps<SVGSVGElement>) => {
	return (
		...
		>
			...
			/>
			<path
				d="M4.66675 7.33301V4.66634C4.66675 3.78229 5.01794 2.93444 5.64306 2.30932C6.26818 1.6842 7.11603 1.33301 8.00008 1.33301C8.88414 1.33301 9.73198 1.6842 10.3571 2.30932C10.9822 2.93444 11.3334 3.78229 11.3334 4.66634V7.33301"
				stroke="currentColor"
				strokeWidth="2"
				strokeLinecap="round"
				strokeLinejoin="round"
